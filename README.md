...
The comma is recommended Stata syntax. For simple cases, `smartload` also accepts bare options after the file name:
...
For convenience, simple bare options may also be typed after the file name without a comma:
